...
public interface RuleVisitor<E extends Throwable> {
  ...
  public static class Adapter<E extends Throwable> implements RuleVisitor<E> {
    ...
    @Override public void visit(Terminal rule) throws E {}

    @Override public void visit(Production rule) throws E {}

    @Override public void visit(Reference rule) throws E {}

    @Override public void visit(Action rule) throws E {}

    @Override public void visit(Concatenation rule) throws E {}

    @Override public void visit(Alternation rule) throws E {}

    @Override public void visit(Repetition rule) throws E {}

    @Override public void visit(Exclusion rule) throws E {}
