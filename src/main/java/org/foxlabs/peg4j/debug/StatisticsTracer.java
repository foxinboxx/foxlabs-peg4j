...
public class StatisticsTracer implements RuleTracer {
    ...
    protected final Map<String, HitLatencyCounter> terminalStatisticsTable = new LinkedHashMap<String, HitLatencyCounter>();
    protected final Map<String, HitLatencyCounter> productionStatisticsTable = new LinkedHashMap<String, HitLatencyCounter>();
    protected final Map<String, HitLatencyCounter> actionStatisticsTable = new LinkedHashMap<String, HitLatencyCounter>();
    
    protected final HitCounter totalMemoCounter = defaultHitCounter();
    protected final Map<Reference, HitCounter> memoStatisticsTable = new IdentityHashMap<Reference, HitCounter>();
