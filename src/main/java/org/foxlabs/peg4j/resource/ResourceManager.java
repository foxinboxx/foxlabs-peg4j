...
public abstract class ResourceManager {
  ...
  private static final String[] PRODUCT_INFO =
      ResourceHelper.readManifestAttributes("Peg4j-Name", "Peg4j-Version", "Peg4j-URL");

  public static final String RESOURCE_DIRECTORY =
      ResourceHelper.getResourcePath(ResourceManager.class);

  private static final MessageBundle RUNTIME_BUNDLE =
      MessageBundle.getInstance(RESOURCE_DIRECTORY + "/runtime-messages");

  private static final MessageBundle PROBLEM_BUNDLE =
      MessageBundle.getInstance(RESOURCE_DIRECTORY + "/problem-messages");

  private static final MessageBundle CLI_BUNDLE =
      MessageBundle.getInstance(RESOURCE_DIRECTORY + "/cli-messages");
  ...
  public static String getProductURL() {
    if (PRODUCT_INFO[2] == null) {
      PRODUCT_INFO[2] = "https://foxlabs.org/foxlabs-peg4j/";
    }
