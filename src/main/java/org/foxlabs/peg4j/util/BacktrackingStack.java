 ...
 * marked position meaning that elements pushed after this mark are lost. Depth
...
public class BacktrackingStack<E> {
   ...
   * 
   * @return <code>true</code> if this stack has no elements; <code>false</code>
   *         otherwise.
   */
   ...
   * position by latest {@link #mark()} method call or total number of elements
   * if markers stack is empty.
   * 
   ...
   * beginning of this stack if markers stack is empty. If number of elements in
   * the stack is greater than length of the specified array then array will be
   * filled with first front elements.
   * 
  ...
  /**
   * Retrieves, but does not remove, elements from this stack into the specified
   * array starting from previously saved position by latest {@link #mark()}
   * call or from the beginning of this stack if markers stack is empty. If
   * number of elements in the stack is greater than length of the specified
   * array then array will be filled with first front elements.
   * 
   * @return Array of elements at the front of this stack.
   */
