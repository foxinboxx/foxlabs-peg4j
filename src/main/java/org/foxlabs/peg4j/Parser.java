 ...
 * the {@link Parser#setTracer(RuleTracer)} method. A number of convenient
...
public abstract class Parser<T> {
    ...
    /**
     * This flag is used to enable or disable memoization feature for this
     * parser. By default memoization is enabled.
     */
     ...
     * or {@link org.foxlabs.peg4j.grammar.GrammarParser}. Also you can create
     * your parser from the {@link DefaultParser} class. </p>
     * 
     ...
     * 
     * <p> According to grammar rules parser may execute semantic actions and
     * each action should be executed in separate transaction. Parser can
     * invoke this method many times during recognition process when
     * transactional behavior is required. </p>
     * 
    ...
    /**
     * Returns tracer that will be used by this parser to keep track of
     * parsing process.
     * 
     * @return Tracer that will be used by this parser to keep track of
     *         parsing process.
     */
     ...
     * @return Semantic result of parsing.
     * @throws IOException if IO error occurred.
     * @throws RecognitionException if parser cannot recognize content
     *         retreived from the specified URL.
     */
     ...
     * @throws IOException if IO error occurred.
     * @throws RecognitionException if parser cannot recognize content
     *         retreived from the specified file.
     */
    ...
    private class MemoContext extends Context {
         ...
         * 
         * <p> Snapshot considered to be successfully applied if it was found
         * in the cache and transaction was successfully loaded or position in
         * the input character stream was changed. </p>
         * 
        ...
        /**
         * Returns snapshot of changes in the scope of the current transaction
         * as separate transaction instance.
         * 
         * <p> If current transaction does not support memoization feature or
         * has no changes and position in the input character stream is
         * unchanged then <code>null</code> will be returned.
         * This method returns {@link Transaction#STATELESS} if transaction
         * does not support memoization feature or has no changes but position
         * in the input character stream has been changed. </p>
         * 
         * @return Snapshot of changes in the scope of current transaction as
         *         separate transaction instance or <code>null</code> if there
         *         is nothing to save.
        ...
        /**
         * Returns snapshot ID that is concatenation of current production
         * index and offest in the input character stream.
         * 
         * @return Snapshot ID that is concatenation of current production
         *         index and offest in the input character stream.
         */
